...
const ExamQuestionPage: React.FC = () => {
    ...
    return (
        <PageContainer title={examVersion?.name} extra={<Button type="primary" onClick={() => {
            setQuestion(null);
            setOpen(true);
        }}>Tạo câu hỏi</Button>}>
            <ProTable
                    ...
                    },
                    {
                        ...
                        render: (_, entity) => [
                            ...
                            <Tooltip key="answer" title="Câu trả lời">
                                <Button icon={<FolderOutlined />} size="small" disabled={entity.type === 3} onClick={() => history.push(`/exam/answer/${entity.id}`)} />
                            </Tooltip>,
