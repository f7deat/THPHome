import '../css/lost-in-space-login.css'

const LostInSpaceLogin = () => {
    return (
        <div className="bg-gray-800 w-screen h-screen">
            <div id="particles-js" className="fixed opacity-25 w-full h-full m-0" />
            <h1 className="text-center text-white font-bold" style={{ fontSize: 100, fontFamily: 'Dosis' }}>Lost In Space</h1>
            <div className="denied__wrapper relative block">
                <svg id="planet" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="319.166" cy="208.081" r="28.389" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="234.463" cy="273.978" r="19.358" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="307.493" cy="144.207" r="12.584" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="163.289" cy="255.495" r="19.358" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="230.586" cy="365.92" r="19.358" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="302.221" cy="353.781" r="19.357" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="358.827" cy="284.847" r="11.079" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="220.465" cy="156.416" r="11.079" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="154.027" cy="171.743" r="5.819" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="391.387" cy="251.305" r="5.819" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="145.077" cy="302.473" r="5.819" fill="#D83A4E" />
                    ...
                    <circle className="hover transition duration-1000 ease-in-out" cx="187.342" cy="355.265" r="5.819" fill="#D83A4E" />
                ...
                <div className="flex justify-center">
                    <a href="/Identity/Account/Login" className="denied__link text-white px-4 py-3 rounded-md border block text-center">Go To Login</a>
                </div>
            </div>
        </div>
    )
}
export default LostInSpaceLogin